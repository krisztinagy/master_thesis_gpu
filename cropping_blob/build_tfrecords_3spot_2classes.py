...
tf.app.flags.DEFINE_string('crops_dir', os.path.join( cfg.dir['data'], (cfg.dir['full_images'] + '_3slot_crops')), 'Crops folder')
tf.app.flags.DEFINE_string('training_dir', os.path.join( cfg.dir['data'], (cfg.dir['full_images'] + '_3slot_crops' + cfg.dir['crops_special_note']), 'training' ), 'Training data folder')
tf.app.flags.DEFINE_string('testing_dir', os.path.join( cfg.dir['data'], (cfg.dir['full_images'] + '_3slot_crops' + cfg.dir['crops_special_note']), 'testing' ), 'Testing data folder')
tf.app.flags.DEFINE_string('tfrecords_dir', os.path.join( cfg.dir['data'], ('tfrecords_3slot_cam' + cfg.dir['full_images'] + cfg.dir['records_special_note'])), 'tfRecords folder')
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
  ...
  for s in range(num_shards_per_batch):
    ...
    for i in files_in_shard:
      ...
      example = _convert_to_example(height, width, label_new, filename, image_buffer)
