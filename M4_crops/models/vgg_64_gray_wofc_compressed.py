...
class Vgg19:
    ...
    def inference_graph(self, grayscale, train_mode=None, image_pixels = cfg.image['height']*cfg.image['width'], num_classes = 2):
        ...
        self.conv1_1 = self.conv_layer(grayscale_reshaped, 1, 8, "conv1_1")
        self.conv1_2 = self.conv_layer(self.conv1_1, 8, 8, "conv1_2")
        self.pool1 = self.max_pool(self.conv1_2, 'pool1')

        self.conv2_1 = self.conv_layer(self.pool1, 8, 16, "conv2_1")
        self.conv2_2 = self.conv_layer(self.conv2_1, 16, 16, "conv2_2")
        self.pool2 = self.max_pool(self.conv2_2, 'pool2')

        self.conv3_1 = self.conv_layer(self.pool2, 16, 32, "conv3_1")
        self.conv3_2 = self.conv_layer(self.conv3_1, 32, 32, "conv3_2")
        self.conv3_3 = self.conv_layer(self.conv3_2, 32, 32, "conv3_3")
        self.conv3_4 = self.conv_layer(self.conv3_3, 32, 32, "conv3_4")
        self.pool3 = self.max_pool(self.conv3_4, 'pool3')

        self.conv4_1 = self.conv_layer(self.pool3, 32, 64, "conv4_1")
        self.conv4_2 = self.conv_layer(self.conv4_1, 64, 64, "conv4_2")
        self.conv4_3 = self.conv_layer(self.conv4_2, 64, 64, "conv4_3")
        self.conv4_4 = self.conv_layer(self.conv4_3, 64, 64, "conv4_4")
        self.pool4 = self.max_pool(self.conv4_4, 'pool4')

        self.conv5_1 = self.conv_layer(self.pool4, 64, 64, "conv5_1")
        self.conv5_2 = self.conv_layer(self.conv5_1, 64, 64, "conv5_2")
        self.conv5_3 = self.conv_layer(self.conv5_2, 64, 64, "conv5_3")
        self.conv5_4 = self.conv_layer(self.conv5_3, 64, 64, "conv5_4")
        self.pool5 = self.max_pool(self.conv5_4, 'pool5')
        
        # 2048 = ((64 // (2 ** 5)) ** 2) * 64
        self.fc6 = self.fc_layer(self.pool5, 256, num_classes, "fc6")        
        self.output = tf.nn.softmax(self.fc6, name="prob")
